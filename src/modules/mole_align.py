...
from src.utils import gen_sub_projection, graph_batch_from_smile, drug_sdf_db
from utils import AdjAttenAgger
from gnn.GNNs import DrugGVPModel
from Transformer import SAB

class KG_align(nn.Module):
    def __init__(self, cross_modal_encoder, clip_net, emb_dim,device):
...
class ThreeD_align(torch.nn.Module):
    def __init__(self, cross_modal_encoder, clip_net, emb_dim,device=torch.device('cuda:0')):
